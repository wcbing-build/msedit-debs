自行打包的 [msedit](https://github.com/microsoft/edit)，适用于 Debian 或基于 Debian 的发行版。

Self-packaged [msedit](https://github.com/microsoft/edit), suitable for Debian and Debian-based distros.
