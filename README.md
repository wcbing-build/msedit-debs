...
直接从 [Releases](https://github.com/wcbing-apt-repo/msedit-debs/releases) 下载 .deb 文件。

### 添加 apt 仓库

```sh
echo "Types: deb
URIs: https://github.com/wcbing-apt-repo/msedit-debs/releases/latest/download/
Suites: ./
